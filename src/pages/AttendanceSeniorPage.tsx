...
export default function AttendanceSeniorPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!event || !event.spreadsheet_url_senior) {
      ...
      <div className="max-w-2xl mx-auto">
        <GlassCard className="p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            />
            <div>
              <h1 className="text-2xl font-bold text-white">Absensi Senior</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed"
            >
